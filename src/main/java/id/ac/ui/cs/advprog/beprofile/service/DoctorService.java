...
public class DoctorService {
    ...
    private List<CaregiverDto> filterCaregiversBySchedule(List<CaregiverDto> caregivers, String workingSchedule) {
        try {
            ...
            List<ScheduleDto> allSchedules = konsultasiServiceClient.getAvailableSchedules(caregiverIds);
            
            List<String> availableCaregiverIds = allSchedules.stream()
            ...
            return caregivers.stream()
                    .filter(caregiver -> availableCaregiverIds.contains(caregiver.getId()))
                    .collect(Collectors.toList());
